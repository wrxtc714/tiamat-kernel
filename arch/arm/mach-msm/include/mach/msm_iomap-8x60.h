...
#define MSM_IMEM_BASE		IOMEM(0xFA305000)
...
#define MSM_EBI1_CH0_BASE	IOMEM(0xFA702000)
...
#define MSM_HTC_DEBUG_INFO_BASE		IOMEM(0xFA802000)
...
#define MSM_SCL_HTC_PRIV_BASE		IOMEM(0xFA822000)
